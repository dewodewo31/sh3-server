...
@section('stats')
    ...
    <div class="bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition">
        <div class="flex items-center gap-2 mb-2">
            ...
            <p class="text-gray-400 text-sm">Participant</p>
        </div>
        <h3 class="text-2xl font-bold text-blue-400">{{ $totalParticipants }}</h3>
    </div>
@endsection
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-b border-white/10 hover:bg-white/5 transition">
                ...
                <td class="py-3 px-4">
                    @if($user->role == 'admin')
                        <span class="px-2 py-1 bg-purple-500/20 text-purple-300 rounded-full text-xs">Admin</span>
                    @elseif($user->role == 'organizer')
                        <span class="px-2 py-1 bg-yellow-500/20 text-yellow-300 rounded-full text-xs">Organizer</span>
                    @else
                        <span class="px-2 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs">Participant</span>
                    @endif
                </td>
