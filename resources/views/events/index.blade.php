...
<div class="flex justify-between items-center mb-6">
    ...
    <!-- EXPORT -->
        <a href="{{ route('events.export-all-pdf') }}{{ request()->getQueryString() ? '?' . request()->getQueryString() : '' }}"
           class="bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 px-4 py-2 rounded-lg transition flex items-center gap-2 border border-blue-500/30">
        ...
        <a href="{{ route('events.create') }}"
           class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition flex items-center gap-2 shadow-lg shadow-green-500/20">
